...
모든 움직임과 총알 한 발은 생존 시간과 직결되며, 플레이어는 이 모든 상황이 **더 큰 임무**의 일부였음을 종국에 깨닫게 됩니다.
...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td>🩰Balerina</td>
      <td>불쾌한 댄싱 머신</td>
      <td>속도가 매우 빨라 조준이 어렵습니다. 7대 맞으면 사망하므로 빠른 반응을 강제합니다..</td>
      <td>3발 (15 HP)</td>
    </tr>
    <tr>
      <td>🐐GoreTex</td>
      <td>무기를 휘두르는 산양 괴수</td>
      <td>12발로 처치 가능하지만, 1~2대만 맞아도 체력 30%가 소모되어 매우 위험합니다..</td>
      <td>12발 (60 HP)</td>
    </tr>
     <tr>
      <td>🐙Kraken</td>
      <td>옥상을 지키는 촉수의 화신</td>
      <td>플레이어가 맵에서 탄약과 수류탄을 얼마나 아꼈는지 시험합니다.</td>
      <td>50발 (250 HP)</td>
    </tr>
  </tbody>
</table>
...
| **체력 회복** | `Q` | 응급 주사(Morphine Syringe) 투여. |
